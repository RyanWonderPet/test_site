...
<html lang="en">
   ...
   <body>
      <header>
         ...
         <div id="div-homeservices" class="clearfix" style="width: 100%;min-height: 20px; background-color: rgb(47, 207, 19);
            margin-bottom: 10px;
            }">
            <div id="div-services" class="col-lg" style="width: 50%; min-height: 40px; float: left; line-height: 40px; padding-left: 170px; color: white;">Services</div>
