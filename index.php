 ...
 <nav class="navbar navbar-expand-lg navbar-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto" style="margin-right: 200px">
      ...
      <li class="nav-item">
      <a class="nav-link" href="#"><i class="fa-brands fa-twitter"></i></i> <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      <a class="nav-link" href="#"><i class="fa-brands fa-facebook"></i> <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      <a class="nav-link" href="#"><i class="fa-brands fa-instagram"></i> <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      <a class="nav-link" href="#"><i class="fa-brands fa-linkedin"></i> <span class="sr-only">(current)</span></a>
      </li>
    </ul>
  </div>
</nav>
...
<div id="containerr" class="container">
 ...
 <div class="row">
    ...
    <div id="column2" class="column" style="background-color:white;" style="width: 50%;">
     <p style="font-size: 13px;">Ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in <br>reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Exepteur<br>sint occaecat cupidatat non proident, sunt in culpa qui official deserunt mollit anim id <br>est laborum</p>
...
<!-- Footer -->
<footer class="text-center text-lg-start text-muted" style="padding: 1px; background-color: rgb(32, 32, 32);
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 text-left mb-md-0 mb-4 text-white">
          <!-- Links -->
          <h6 class="text-uppercase fw-bold mb-4">Join Our Newsletters</h6>
