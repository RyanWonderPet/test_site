...
<html>
 ...
 <header>
    ...
    <div class="embed-responsive">	
        <div class="float-left text-white embed-responsive" style="background-color:rgb(38, 204, 40 ); width: 100%; height: 40px; padding-top: 8px"><span style="margin-left: 167px;">Services<span class="float-right" style="margin-right: 223px">Home/Services<span></div>
    </div>
</div>
</header>
